          ...
          <div className="sidebar-info_more">
            ...
            <ul className="social-list">
              <li className="social-item">
                <a rel="noreferrer" target={'_blank'} href="https://www.linkedin.com/in/ebraheem-ijaz-0a685a122/" className="social-link">
                  <ion-icon name="logo-linkedin" role="img" className="md hydrated" aria-label="linkedin"></ion-icon>
                </a>
              </li>
              <li className="social-item">
                <a rel="noreferrer" target={'_blank'} href="https://www.upwork.com/freelancers/~011a9306f4d36f0027" style={{
              ...
              <li className="social-item">
                <a rel="noreferrer" target={'_blank'} href="https://www.fiverr.com/coder2" style={{
                  width: '1em', height: '1em'
                }} className="social-link">
                  <div className="icon-inner">
                    <FiverrLogo />
        ...
        <div className="main-content">
          ...
          <article className={`about ${activePage === 'about' ? 'active' : ''}`} >
            ...
            <section className="about-text">
              <p>
                My name is Ebraheem, I&aposm a senior full stack developer having experience more than 5 years, and I love what I do.
              </p>
              <p>
              ...
              <p>
                Nowadays, I am completely working as a freelancer, where I help clients with their web development needs. My job is completely
            ...
            <section className="clients">
              ...
              <ul className="clients-list has-scrollbar">
                <li className="clients-item">
                  <a href="https://arpitools.com/" rel="noreferrer" target={'_blank'}>
                    <Image src="/client1.png" alt="client logo" style={{ width: 75 }} />
                    {/* <img  /> */}
                  </a>
                </li>
              </ul>
                  ...
                  <li className="project-item  active" key={index}>
                    <a href={each.link} rel="noreferrer" target={'_blank'}>
                      <figure className="project-img">
                        ...
                        {/* <img src={each.image} /> */}
                        <Image src={`/${each.image}`} loading="lazy" alt={each.title} />
                      </figure>
